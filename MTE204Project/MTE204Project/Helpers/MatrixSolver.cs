...
namespace MTE204Project.Helpers
{
    public static class MatrixSolver
    {
        ...
        public static double SetPrincipleAngles(double x, double y)
        {
        ...
        public static IEnumerable<FinalAngles> RunPointSimulation(double endXIn, double endYIn, double endZIn)
        {
            ...
            var principleAngle = SetPrincipleAngles(endXIn, endYIn);
            ...
            for (int angle = 0; angle < 360; angle++)
            {
                ...
                if (WillSolutionConverge(endR, endZ, endPsi))
                {
                    ...
                    var config = new FinalAngles(principleAngle, guesses[0], guesses[1], guesses[2], angle);
